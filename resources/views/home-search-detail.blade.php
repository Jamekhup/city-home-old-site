@extends('master')
@section('title')
<title>Property Search Result Detail</title>
@endsection
@section('css')
            ...
            <div class="all_lists">
                ...
                <div class="row">
                    ...
                    <div class="col" id="listItems">
                        ...
                        <p></p>
                        <div class="list-bg"
                            style="background-image:url({{asset('storage/adminUploads/'.$list->mainImage)}})">
...
<div class="listDetail2" style="display:block;">
    ...
    <div class="detailInside">
        ...
        <div class="row">
            <div class="col1">
                <div id="imgClick" style="background-image:url({{asset('storage/adminUploads/'.$single->mainImage)}})"
