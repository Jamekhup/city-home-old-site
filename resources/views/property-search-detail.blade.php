...
@section('css')
@section('title')
<title>Real Estates in Yangon - Search Result Details</title>
@endsection
...
<div class="listDetail2" style="display:block;">
    ...
    <div class="detailInside">
        ...
        <div class="row">
            <div class="col1">
                <div id="imgClick" style="background-image:url({{asset('public/adminUploads/'.$single->mainImage)}})"
                    class="mainImg forMobile"></div>
                @php
                ...
                <div class="itemDetail">
                    <div class="row2">
                        <h1><span>
                                ...
                                ?>
                                <span id="sortPrice">{{$single->price}}</span> {{$single->money}} <span
                                    id="perMonth">/mo</span>
                                <?php
                                ...
                                ?>
                                {{$single->money}} <span id="sortPrice">{{$single->price}}</span> <span
                                    id="perMonth">/mo</span>
                                <?php
                    ...
                    <p class="bed">{{$single->bedrooms}} Bedrooms | {{$single->bathrooms}} Bathrooms |
                        {{$single->floor}} | {{$single->square_feet}} Sqrft</p>
