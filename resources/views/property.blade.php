...
@section('css')
@section('title')
<title>Properties for rent and for sale in Yangon, Myanmar - City Home Property Co.,ltd</title>
@endsection
        ...
        <div class="proLists">
            <div class="row">
                ...
                <div class="all_lists">
                    ...
                    <h1>{{str_replace(' ',' ',ucwords(str_replace('-',' ',$property[0]->category)))}} {{str_replace(' ',' ',ucwords(str_replace('-',' ',$property[0]->saleRent)))}}  <span>{{$property->total()}} Listings</span></h1> 
       ...
       <div class="requestToApply">
           <button class="closeRequestToApply">&times;</button>
            <form action="{{route('requestApply')}}" id="requestToApply" method="POST">
                ...
                <textarea id="rSms" cols="30" rows="10" placeholder="Why would you like to apply this property? (optional)"></textarea>
