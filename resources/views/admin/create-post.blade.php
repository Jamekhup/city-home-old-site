    ...
    <div class="col-xs-12">
        <section class="panel">
            <header class="panel-heading" id="pnhead">
                <h2 class="panel-title" id="pntitle">Create New Post</h2>
            </header>
            <div class="panel-body">
                
                <form action="{{route('dashboard.store')}}" class="form-horizontal form-bordered" id="uploadPost"  enctype="multipart/form-data">
                   @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="address" type="text" id="address" class="form-control" placeholder="Enter Address">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" id="space">
                            <input name="bedroom" type="text" id="bedroom" class="form-control" placeholder="Bed Rooms">
                        </div>
                        <div class="col-md-4">
                            <input name="bathroom" type="text" id="bathroom" class="form-control" placeholder="Bath Rooms">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" id="space">
                            <input name="floor" type="text" id="floor" class="form-control" placeholder="1st floor/4-story">
                        </div>
                        <div class="col-md-4">
                            <input name="squarefeet" type="text" id="squarefeet" class="form-control" placeholder="Square Feet">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Car Parking</label>
                        <div class="col-md-8">
                            <input name="carpark" type="text" id="carpark" class="form-control" placeholder="Car Parking">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea name='description'  class="form-control" placeholder="Description" style="height:300px" ></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="otherImage[]" multiple type="file" id="otherImage" class="form-control" onchange="selectImage()" style="display:none;">
                            <button type="button" class="btn btn-dark" onclick="document.getElementById('otherImage').click()">Upload Multiple Images</button><br>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-8" >
                            <button id="adminUploadBtn" type="submit" class="btn btn-block btn-info">Upload</button>
                        </div>
                    </div>
                </form>
...
<script>
    $('#uploadPost').on('submit', uploadData);
    ...
    e.preventDefault();
        ...
        $.ajax({
            ...
            contentType: false,
            beforeSend: function () {
                $('#adminUploadBtn').text('Uploading and Sending Mail, Please Wait...');
            },
